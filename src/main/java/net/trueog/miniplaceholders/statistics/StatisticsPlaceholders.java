...
public class StatisticsPlaceholders {
	...
	public void registerPlaceholders() {
		...
		UtilitiesOG.registerAudiencePlaceholder("statistic_time_played:hours", player -> Long.toString(TimeUnit.SECONDS.toHours(getSecondsPlayed(player)) % 24));
		UtilitiesOG.registerAudiencePlaceholder("statistic_time_played:days", player -> Long.toString(TimeUnit.SECONDS.toDays(getSecondsPlayed(player))));

		UtilitiesOG.registerAudiencePlaceholder("statistic_seconds_played", player -> Integer.toString(getSecondsPlayed(player)));
		UtilitiesOG.registerAudiencePlaceholder("statistic_minutes_played", player -> Long.toString(TimeUnit.SECONDS.toMinutes(getSecondsPlayed(player))));
